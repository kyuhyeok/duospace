...
function printDuogram(data) {
	...
	if(dataCount!=0) {
		for(var idx=0; idx<data.list.length; idx++) {
			...
			out+="      </a>";
			out+="    </div>";
			out+="    <div style='float:left;'><a href='#' style='text-decoration:none; color: black; font-family: '나눔고딕';'>"+userId+"</a></div>";
			out+="    <div style='float:right;'><a href='#' style='text-decoration:none; color: #ccc; font-family: '나눔고딕';'><img src='<%=cp%>/resource/images/duogram/dot.PNG' style='width: 12px; height: 3px;'></a></div>";
			out+="    </div>";
			out+="    </div>";
			...
			out+="    <a href='#' style='text-decoration:none; color: black; font-size: 35px;'></a>"; //좋아요 하트 들어갈자리
			out+="    </div>";
			out+="    <div style='height: 15px; margin-bottom: 10px; padding-left: 15px; padding-right: 15px;'>";
			out+="    <div style='margin-top: 5px;'>";
			out+="    <div style='float:left; font-size: 14px; font-weight: bold font-family: '나눔고딕';'></div>"; // 좋아요 갯수 들어갈자리
			out+="    <div style='float:left; font-size: 14px;'>";
			out+="    <a href='#' style='text-decoration:none; color: #999; font-family: '나눔고딕';'></a>"; // 댓글 갯수 들어갈자리
			out+="    </div>";
			out+="    </div>";
			out+="    </div>";
			out+="    <div style='font-family: '나눔고딕'; padding-top: 10px; padding-left: 15px; padding-right: 15px; padding-bottom: 10px; width: 584px; font-weight: normal; font-size: 14px; line-height: 1;'>"+content+"</div>";
...
<div style="background: #fafafa; min-height: 2000px">
	...
	<div style="width: 627px;">
		...
		<div class="wrap" style="width: 614px; float: left;">
			...
			<!-- 왼쪽 게시글들 -->
			<div id="listDuogram">
			<table style="width: 614px; border: 1px solid rgba(0,0,0,.0975); float:left; background-color: white; border-radius: 3px;">
	           <thead>
	           </thead>
	           <tbody id="listDougramBody"></tbody>
			</table>
			</div>
		</div>
	</div>
