...
<div class="bodyFrame2">
    ...
    <div>
        <form name="moimalbumForm" method="post" onsubmit="return check();" enctype="multipart/form-data">
            <div class="bs-write">
                <table class="table">
                    <tbody>
                        <tr>
                            ...
                            <td class="td2 col-md-5 col-sm-5">
                                <p class="form-control-static">${sessionScope.moimmember.alNum}</p>
                            </td>
                        ...
                        <tr>
                            <td colspan="4" class="td4">
                            	<textarea name="content" class="form-control" rows="7">${dto.content}</textarea>
                            </td>
                        </tr>
