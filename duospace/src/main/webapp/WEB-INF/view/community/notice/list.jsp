...
<div class="container" role="main">
	...
	<div>
		...
		<table class="noticeList"
			style="margin: 10px auto 0px; border-spacing: 0px; border-collapse: collapse; width: 100%">
			<tr style="background: #eeeeee; border-top: 1px solid black"
				height="35px;">
		...
		<table style="width: 100%">
			<tr>
				<td><select name="searchKey">
					...
					<button type="button">검색</button> <input type="hidden" name="rows"
					value="${rows}"></td>
				<td align="right"><c:if
						test="${sessionScope.user.userId=='admin' }">
						<button type="button"
							onclick="javascript:location.href='<%=cp%>/community/notice/created';">글올리기</button>
					</c:if></td>
			</tr>
